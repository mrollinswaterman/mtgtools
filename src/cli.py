...
parser.add_argument("-p", "--parameter", help="""parameter for analysis. for a detailed list
...
if args.parameter:
    if args.parameter in allowed_parameters:
        ...
        if skipped > 0:
            print(f"some cards were unable to be analyzed with the parameter '{args.parameter}'. {skipped} card(s) skipped.\n")
